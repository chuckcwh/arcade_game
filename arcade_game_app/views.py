...
from arcade_game import settings
from arcade_game_app.forms import EmailUserCreationForm
from arcade_game_app.models import Pokemon, Team
...
def pokemon_new_game(request):
    return render(request, 'pokemon/pokemon_new_game.html')


@login_required
def pokemon_load_game(request):
    return render(request, 'pokemon/pokemon_load_game.html')


@login_required
def pokemon_battle(request):
    return render(request, 'pokemon/pokemon_battle.html')


@login_required
def pokemon_lab(request):
    return render(request, 'pokemon/pokemon_lab.html')
